...
@Neg_Reg @Password_Reg
Scenario:
    When I add "1234" to the inputfield "#input-password"
    And I add "12345" to the inputfield "#input-confirm"
    And I click on the element "input[type='submit']"
    Then I expect that element "//div[.='Password confirmation does not match password!']" becomes displayed
