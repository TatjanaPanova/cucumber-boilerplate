...
Scenario:
    When I add "123456789012345678901" to the inputfield "#input-password"
    And I click on the element "input[type='submit']"
    Then I expect that element "//div[.='Password must be between 4 and 20 characters!']" becomes displayed
